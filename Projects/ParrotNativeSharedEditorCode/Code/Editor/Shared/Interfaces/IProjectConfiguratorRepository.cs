...
{
    /// <summary>
    /// A config repository for retrieving a <see langword="IEnumerable"/> of <see cref="IProjectConfigurator"/>
    /// </summary>
    public interface IProjectConfiguratorRepository
    {
        /// <summary>
        ...
        IEnumerable<T> GetAll<T>() where T : IProjectConfigurator;
        ...
        /// <returns>A <see langword="IEnumerable"/> of <see cref="IProjectConfigurator"/></returns>
        IEnumerable<T> GetByBuild<T>(BuildTarget buldTarget, Build build) where T : IProjectConfigurator;
    }
}
